...
<script type="text/javascript">
    $(document).ready(function() {
        ...
        var table = $('#prTables').DataTable({
            ...
            'ajax' : { url: '<?=site_url('salones/get_alquiler/'.$store->id);?>', type: 'POST', "data": function ( d ) {
                    ...
                    <table id="prTables" class="table table-striped table-bordered table-hover" style="margin-bottom:5px;">
                        <thead>
                            <tr class="active">
                                ...
                                <th><?= lang("nombre_cliente"); ?></th>
                                <th><?= lang("nombre_salon"); ?></th>
                                <th><?= lang("hora_entrada"); ?></th>
                                <th><?= lang("hora_salida"); ?></th>
                                <th><?= lang("total"); ?></th>
                            </tr>
                        </thead>
                        <tbody>
                        ...
                        <tfoot>
                            <tr>
                                ...
                                <th><input type="text" class="text_filter" placeholder="[<?= lang('created_at'); ?>]"></th>
                                <th><input type="text" class="text_filter" placeholder="[<?= lang('nombre_cliente'); ?>]"></th>
                                <th><input type="text" class="text_filter" placeholder="[<?= lang('nombre_salon'); ?>]"></th>
                                <th><input type="text" class="text_filter" placeholder="[<?= lang('hora_entrada'); ?>]"></th>
                                <th><input type="text" class="text_filter" placeholder="[<?= lang('hora_salida'); ?>]"></th>
