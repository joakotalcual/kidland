...
<script type="text/javascript">
    $(document).ready(function() {
        ...
        var table = $('#prTables').DataTable({
            ...
            'ajax' : { url: '<?=site_url('salones/get_horario/'.$store->id);?>', type: 'POST', "data": function ( d ) {
                    ...
                    <table id="prTables" class="table table-striped table-bordered table-hover" style="margin-bottom:5px;">
                        <thead>
                            <tr class="active">
                                ...
                                <th><?= lang("nombre"); ?></th>
                                <th><?= lang("Hora entrada"); ?></th>
                                <th><?= lang("Hora salida"); ?></th>
                        ...
                        <tfoot>
                            <tr>
                                ...
                                <th><input type="text" class="text_filter" placeholder="[<?= lang('Hora entrada'); ?>]"></th>
                                <th><input type="text" class="text_filter" placeholder="[<?= lang('Hora salida'); ?>]"></th>
                                <th style="width:30px;"><?= lang("actions"); ?></th>
                            </tr>
                            <tr>
