    ...
    <aside class="main-sidebar">
        <section class="sidebar" style="overflow-y: scroll !important;">
            <ul class="sidebar-menu">
                ...
                <li class="mm_pos" id="mm_juegos_principal"><a href="<?= site_url('juegos'); ?>"><i class="fa fa-th"></i> <span><?= lang('juegos'); ?></span></a></li>
                <li class="mm_restaurantes" id="mm_restaurantes"><a href="<?= site_url('restaurante'); ?>"><i class="fa fa-th"></i> <span><?= lang('RESTAURANTE'); ?></span></a></li>
                <li class="mm_salon" id="mm_salon"><a href="<?= site_url('salones'); ?>"><i class="fa fa-th"></i> <span><?= lang('SALONES'); ?></span></a></li>
                <?php if ($Admin) { ?>
                <li class="treeview mm_juegos">
                    <a href="#">
                        <i class="fa fa-barcode"></i>
                        <span><?= lang('juegos_infantiles'); ?></span>
                        <i class="fa fa-angle-left pull-right"></i>
                    </a>
                    <ul class="treeview-menu">
                        <li id=""><a href="<?= site_url('juegos/list_juegos'); ?>"><i class="fa fa-circle-o"></i> <?= lang('list_juegos'); ?></a></li>
                        <li id=""><a href="<?= site_url('juegos/add'); ?>"><i class="fa fa-circle-o"></i> <?= lang('add_juegos'); ?></a></li>
                        <li id=""><a href="<?= site_url('juegos/list_tipos'); ?>"><i class="fa fa-circle-o"></i> <?= lang('list_tipos'); ?></a></li>
                        <li id=""><a href="<?= site_url('juegos/addTipo'); ?>"><i class="fa fa-circle-o"></i> <?= lang('add_tipos'); ?></a></li>
                        <li id=""><a href="<?= site_url('juegos/list_ventas'); ?>"><i class="fa fa-circle-o"></i> <?= lang('ventas_juegos'); ?></a></li>
                        <li id=""><a href="<?= site_url('juegos/escaneoqr'); ?>"><i class="fa fa-circle-o"></i> <?= lang('escaneo_qr'); ?></a></li>
                    </ul>
                </li>
                <li class="treeview mm_restaurante">
                    <a href="#">
                        <i class="fa fa-barcode"></i>
                        <span><?= lang('Restaurante'); ?></span>
                        <i class="fa fa-angle-left pull-right"></i>
                    </a>
                    <ul class="treeview-menu">
                        <li id=""><a href="<?= site_url('restaurante/list_ventas'); ?>"><i class="fa fa-circle-o"></i> <?= lang('List Ventas'); ?></a></li>
                        <li class="divider"></li>
                        <li id=""><a href="<?= site_url('restaurante/list_mesas'); ?>"><i class="fa fa-circle-o"></i> <?= lang('List Mesas'); ?></a></li>
                        <li id=""><a href="<?= site_url('restaurante/add_mesas'); ?>"><i class="fa fa-circle-o"></i> <?= lang('Agregar Mesas'); ?></a></li>
                        <li class="divider"></li>
                        <li id=""><a href="<?= site_url('restaurante/list_pedidos'); ?>"><i class="fa fa-circle-o"></i> <?= lang('List Pedido'); ?></a></li>
                        <li id=""><a href="<?= site_url('restaurante/add_pedidos'); ?>"><i class="fa fa-circle-o"></i> <?= lang('Agregar Pedido'); ?></a></li>
                        <li class="divider"></li>
                        <li id=""><a href="<?= site_url('restaurante/list_recetas'); ?>"><i class="fa fa-circle-o"></i> <?= lang('List Recetas'); ?></a></li>
                        <li id=""><a href="<?= site_url('restaurante/add_recetas'); ?>"><i class="fa fa-circle-o"></i> <?= lang('Agregar Recetas'); ?></a></li>
                        <li class="divider"></li>
                        <li id=""><a href="<?= site_url('restaurante/list_insumos'); ?>"><i class="fa fa-circle-o"></i> <?= lang('List Insumos'); ?></a></li>
                        <li id=""><a href="<?= site_url('restaurante/add_insumos'); ?>"><i class="fa fa-circle-o"></i> <?= lang('Agregar Insumos'); ?></a></li>
                    </ul>
                </li>
                <li class="treeview mm_salon">
                    <a href="#">
                        <i class="fa fa-barcode"></i>
                        <span><?= lang('Salones'); ?></span>
                        <i class="fa fa-angle-left pull-right"></i>
                    </a>
                    <ul class="treeview-menu">
                        ...
                        <li class="divider"></li>
                        <li id=""><a href="<?= site_url('salones/list_inventario'); ?>"><i class="fa fa-circle-o"></i> <?= lang('List Inventario'); ?></a></li>
                        <li id=""><a href="<?= site_url('salones/add_inventario'); ?>"><i class="fa fa-circle-o"></i> <?= lang('Agregar Inventario'); ?></a></li>
                        <li class="divider"></li>
                        <li id=""><a href="<?= site_url('salones/list_horario'); ?>"><i class="fa fa-circle-o"></i> <?= lang('List Horario'); ?></a></li>
