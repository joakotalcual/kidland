...
<script type="text/javascript">
    $(document).ready(function() {
        ...
        var table = $('#prTables').DataTable({
            ...
            'ajax' : { url: '<?=site_url('restaurante/get_ventas');?>', type: 'POST', "data": function ( d ) {
                    ...
                    <table id="prTables" class="table table-striped table-bordered table-hover" style="margin-bottom:5px;">
                        ...
                        <tfoot>
                            <tr>
                                ...
                                <th><input type="text" class="text_filter" placeholder="[<?= lang('Fecha'); ?>]"></th>
                                <th><input type="text" class="text_filter" placeholder="[<?= lang('Mesa'); ?>]"></th>
                                <th><input type="text" class="text_filter" placeholder="[<?= lang('tipo_pago'); ?>]"></th>
